...
echo '<td class="reportTableHeader" style="width:10%"'.excelFormatCell('header',10).'>'.i18n('nbHandled').'</td>';
echo '<td class="reportTableHeader" style="width:15%"'.excelFormatCell('header',15).'>'.i18n('delayHandled').'</td>';
echo '<td class="reportTableHeader" style="width:10%"'.excelFormatCell('header',10).'>'.i18n('nbNotHandled').'</td>';
echo '<td class="reportTableHeader" style="width:15%"'.excelFormatCell('header',15).'>'.i18n('delayNotHandled').'</td>';
