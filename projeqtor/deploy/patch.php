...
if ($action) {
  ...
  if ($nbFiles>0) {
    ...
    echo '&nbsp;<a class="download" href="'.str_replace('D:\\www\\','http://localhost/',$zipName).'" target="#">'.date('d-m-Y')." à ".date('H:i:s').'</a>';
  } else {
    echo '&nbsp<br/>';
  }
} else {
...
function display() {
  ...
  echo "<table><tr class='header'><td>date</td><td>répertoire</td><td>fichier</td><td class='min50 center'>$button</td></tr>";
