...
$today=new Today();
  ...
  echo '</tr>';
  echo '<tr style="height:10px;">';
  echo '  <td class="dialogLabel" width="10px;"><label>'.i18n('colOrNotSet').'&nbsp;<?php if(!isNewGui()){?>:<?php }?>&nbsp;</label></td>';
  echo '  <td>';
  ...
  echo '</tr>';
  echo '<tr style="height:10px;">';
  echo '  <td class="dialogLabel" width="10px;"><label>'.i18n('todayRefreshParametersScroll').'&nbsp;<?php if(!isNewGui()){?>:<?php }?>&nbsp;</label></td>';
  echo '  <td>';
