...
<div id="rightDivContainer" class="container" dojoType="dijit.layout.BorderContainer" >
  <div>
    <span style="color:black;" class="title" ><?php echo i18n("titleStream");?></span>
  </div>
  
  <div dojoType="dijit.layout.ContentPane" region="center" id="activityStream" style="height:100%;display:inline;" >
  ...
  <div dojoType="dijit.layout.ContentPane" region="bottom" style="border:2px solid black;margin-top:100%;" ><form id='noteFormStream' name='noteFormStream' onSubmit="return false;" >
