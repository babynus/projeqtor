...
$idProject = trim(RequestHandler::getId('idProjectPlannedCons'));
$yearSpinner= RequestHandler::getYear('yearConsPlannedWorkManual');
$monthSpinner= RequestHandler::getMonth('monthConsPlannedWorkManual');
$displayNothing = false;$onlyRes=false;
$listResource = array();
$resourceId = trim(RequestHandler::getId('userNameConsultation'));
$inIdTeam = trim(RequestHandler::getId('idTeamCons'));
$inIdOrga = trim(RequestHandler::getId('idOrganizationCons'));
