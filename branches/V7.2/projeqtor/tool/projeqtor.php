...
$version = "V7.2.1"; // Version of application : Major / Minor / Release
$build = "0208"; // Build number. To be increased on each release
...
function sendMail_phpmailer($to, $title, $message, $object=null, $headers=null, $sender=null, $attachmentsArray=null, $references=null) {
  ...
  if ($object) {
    ...
    debugLog(get_class($object)." is mailable #".$mail->idMailable);
