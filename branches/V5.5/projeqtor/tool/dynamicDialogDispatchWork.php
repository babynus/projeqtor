...
if($nbFutureDays==null || trim($nbFutureDays)=='')$nbFutureDays=10000000000;
$nbFutureDaysBlocking=Parameter::getGlobalParameter('maxDaysToBookWorkBlocking');
if($nbFutureDaysBlocking==null || trim($nbFutureDaysBlocking)=='')$nbFutureDaysBlocking=10000000000;
