      ...
      <table style="width:100%;height:100%;">
        <tr style="height:35px;">
          ...
          <td class="title" style="height:35px;">
            ...
            <div id="buttonDivObjectName" style="width:100%;position:absolute;top:8px;text-overflow:ellipsis;overflow:hidden;"><?php  if (property_exists($obj,'name')){ echo ($obj->name)?'&nbsp;-&nbsp;'.$obj->name:''; }?></div>
          </td>
        </tr>
      </table>  
    </div> 
