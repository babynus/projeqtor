...
<div id="consolidationValidationDiv" class="container" dojoType="dijit.layout.BorderContainer">
  <div id="listDiv" dojoType="dijit.layout.ContentPane" region="top"  style="height:64px;">
   <?php include 'consolidationValidationList.php'?>
  </div>
  <div id="detailDiv" name="detailDiv" dojoType="dijit.layout.ContentPane" region="center" >
