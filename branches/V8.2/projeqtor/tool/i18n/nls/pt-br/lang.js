...
activeCloningStatus: "data cloning active",
...
cancelCloningStatus: "data cloning in deletion request",
...
CantCloseEndDateInvalidOrEndReasonEmpty: "can't close &#58; End date or end reason empty",
...
colChangeIsLDAP: "edit is LDAP status",
...
colChangeStatusIdle: "edit the closed status",
...
colDataCloningCount: "remaining data cloning &#58 ${1}/${2}",
colDate: "data",
...
colDuration: "duração",
colEarnedPeriod: "period of leave rights earned",
...
colNbDaysAfterNowLeaveDemandIsAllowed: "max delay for retroactive absence (days)",
...
colPeriodDuration: "period duration",
...
colStartDayPeriod: "start day period",
colStartMonthPeriod: "start month period",
...
colValidityDuration: "validity duration",
colValue: "valor",
...
copyDataCloningButton: "Copy this environment cloning",
...
DataCloning: "Environement cloning",
dataCloningAccess: "access to environment cloning screen",
dataCloningCreationRequest: "taking account of creation requests",
dataCloningImmediate: "at a fixed frequency",
dataCloningPerDay: "quantity of environment cloning per day",
dataCloningProfileRight: "Right and access per profile",
dataCloningRight: "rights on environment cloning screen",
dataCloningSpecificHours: "at a given time",
dataCloningTotal: "quantity of total environment cloning",
...
deleteCloningStatus: "data cloning deleted on ${1}",
Deleted: "deleted",
...
errorLength: "error password min length &#58 ${1} characters",
...
errorQuantityStartDateEndDateMustBeDefinedTogether: "the quantity&#44; start date and end date must be defined together",
...
errorStrength: "error password too low&#44it must countain &#58",
...
GlobalView: "",
gotoDataCloningButton: "Go to this environment cloning",
...
helpParamPasswordStrength: "determine the strength level of the password",
...
menuDataCloning: "Environment cloning",
...
min: "min",
minMax: "-a capital and a tiny",
minMaxNum: "-a capital and a tiny<br>-one lowercase",
minMaxNumChar: "-a capital and a tiny<br>-one lowercase<br>one special character",
minute: "minuto",
...
passChar: "special character",
passed: "aprovado",
passedTestCaseRun: "marcar caso de teste como &#34;aprovado&#34;",
passMinLength: "min length",
passMinMaj: "uppercase",
passNum: "number",
password: "senha",
...
periodScale: "Escala",
pgsqlDataCloningMessage: "Taking creative requests into account on a PostgreSQL database can only be processed from ${1} to ${2}.",
...
removeDataCloningButton: "Delete this environment cloning",
...
Requested: "requested",
requestedCloningStatus: "data cloning in creation request",
...
startDayPeriod: "start day period",
...
validatedLineWorkPeriod: "validated by ${1} on ${2}",
