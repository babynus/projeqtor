...
canSubscribeForOthers: "Can defined others as followers",
...
colDataCloningCount: "remaining daily creation request &#58 ${1}/${2}",
colDataCloningCountTotal: "remaining environment &#58 ${1}/${2}",
colDate: "data",
...
dataCloningErrorCanNotCopy: "Error cloning data &#58 can't copy code",
dataCloningErrorCanNotCreateFolder: "Error cloning data &#58 can't create a target folder",
dataCloningErrorCantCreateDb: "Error cloning data &#58 can't create database",
dataCloningErrorCantCreateParameter: "Error cloning data &#58 can't create parameters file",
dataCloningErrorCantCreateUnderFolder: "Error cloning data &#58 Can't create files under target folder",
dataCloningErrorCantDeleteFolder: "Error cloning data &#58  Can't create target folder",
dataCloningErrorPathDontExist: "Error cloning data &#58  Target path does not exist",
...
errorReopenControl: "Cannot re-open this item that is under a closed item",
...
errorWorkResource: "resource of work ${4} is '${1}' while resource of assignment ${5} is '${2}' for day ${3}",
...
sectionMode: "Display in section for detail screen",
sectionNote: "Notas",
...
tabSystem: "System",
tabularMode: "Tabular view for detail screen",
tabWork: "Work time",
taken: "taken",
