...
colDataCloningCount: "remaining creation request &#58 ${1}/${2}",
colDate: "data",
...
colIndivisibility: "make it indecable",
...
dataCloningTotal: "global limit of number of cloned environments",
...
min: "min",
minimumThresholdAssignError: "the capacity of the resource must not be less than the minimum threshold of ${1}",
minimumThresholdInputError: "the minimum threshold must not exceed the maximum capacity of ${1}",
...
tooltipIndivisibility: "make it insecable",
