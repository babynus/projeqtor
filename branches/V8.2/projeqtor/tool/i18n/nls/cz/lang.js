...
min: "min",
minimumThresholdAssignError: "The assigned capacity of the resource (taking into account assignment rate) must not be less than the minimum threshold of ${1}",
