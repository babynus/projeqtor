...
function startTitlePane($classObj, $section, $collapsedList, $widthPct, $print, $outMode, $prevSection, $nbCol, $nbBadge=null, $included=null, $obj=null) {
  ...
  if (!$print) {
    ...
    if( Parameter::getUserParameter('paramLayoutObjectDetail')=='0' and $included==false){
      ...
      echo '<div dojoType="dijit.layout.ContentPane" title="'.i18n('tab'.ucfirst($tabName)).(($nbBadge!==null )?'<div id=\''.$tabName.'Badge\' class=\'sectionBadge\' style=\'right:0px;top:0px;width:25%;zoom:0.9; -moz-transform: scale(0.9);\' >'.$nbBadge.'</div>':'').'" style="width:100%;height:100%;overflow:auto;" selected="true">';
