...
In accordance with the requirements of the General Data Regulation Protection (GPDR), you can define a "legal" notice that will be displayed when you log in from the home screen.

Go to the legal notice screen to create your message.

You can define a "legal" notice that will be displayed when you log in from the home screen.
...
You must click on the I accept button for the message to disappear permanently.
