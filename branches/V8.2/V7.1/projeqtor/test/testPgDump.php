...
switch ($action) {
  case "Import" :
    $dbname="projeqtor"; // database name
    $dbconn=pg_pconnect("host=localhost port=5432 dbname=$dbname 
user=projeqtor password=projeqtor"); // connectionstring
    if (!$dbconn) {
      echo "Can't connect.\n";
      exit();
    }
...
<body>
	<form id="dataForm" name="dataForm" method="post"
		...
		<input type="file" name="path" id="path" style="width: 300px" /> <input
			type="submit" value="Import" name="actionButton" id="actionButton" />
