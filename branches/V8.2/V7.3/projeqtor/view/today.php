        ...
        if ($show or $cptSubPrj>0) {
          ...
          if ($workVisibility=='ALL') {
            ...
            echo '  <td class="messageDataValue'.($show?'':'Grey').'" NOWRAP>' . ($show?htmlFormatDate($endDate):'') . '</td>' .
               ...
               '  <td class="messageDataValue'.($show?'':'Grey').'" onclick=\'gotoElement("Ticket",null);refreshProjectSelectorList();stockHistory("Ticket",null,"object");setSelectedProject("'.htmlEnCode($proj->id).'","'.htmlEnCode($proj->name).'");\' style="cursor: pointer;">' . ($show?displayProgress($nbTickets,$nbTicketsAll,$nbTicketsTodo, $nbTicketsDone):'') . '</td>' .
               '  <td class="messageDataValue'.($show?'':'Grey').'" onclick=\'gotoElement("Activity",null);refreshProjectSelectorList();stockHistory("Activity",null,"object");setSelectedProject("'.htmlEnCode($proj->id).'","'.htmlEnCode($proj->name).'");\' style="cursor: pointer;">' . ($show?displayProgress($nbActivities,$nbActivitiesAll,$nbActivitiesTodo,$nbActivitiesDone):'') . '</td>' .
               '  <td class="messageDataValue'.($show?'':'Grey').'" onclick=\'gotoElement("Milestone",null);refreshProjectSelectorList();stockHistory("Milestone",null,"object");setSelectedProject("'.htmlEnCode($proj->id).'","'.htmlEnCode($proj->name).'");\' style="cursor: pointer;">' . ($show?displayProgress($nbMilestones,$nbMilestonesAll,$nbMilestonesTodo,$nbMilestonesDone):'') . '</td>' .
               '  <td class="messageDataValue'.($show?'':'Grey').'" onclick=\'gotoElement("Action",null);refreshProjectSelectorList();stockHistory("Action",null,"object");setSelectedProject("'.htmlEnCode($proj->id).'","'.htmlEnCode($proj->name).'");\' style="cursor: pointer;">' . ($show?displayProgress($nbActions,$nbActionsAll,$nbActionsTodo,$nbActionsDone):'') . '</td>' .
               '  <td class="messageDataValue'.($show?'':'Grey').'" onclick=\'gotoElement("Risk",null);refreshProjectSelectorList();stockHistory("Risk",null,"object");setSelectedProject("'.htmlEnCode($proj->id).'","'.htmlEnCode($proj->name).'");\' style="cursor: pointer;">' . ($show?displayProgress($nbRisks,$nbRisksAll,$nbRisksTodo,$nbRisksDone):'') . '</td>' .
               '  <td class="messageDataValue'.($show?'':'Grey').'" onclick=\'gotoElement("Issue",null");refreshProjectSelectorList();stockHistory("Issue",null,"object");setSelectedProject("'.htmlEnCode($proj->id).'","'.htmlEnCode($proj->name).'");\' style="cursor: pointer;">' . ($show?displayProgress($nbIssues,$nbIssuesAll,$nbIssuesTodo,$nbIssuesDone):'') . '</td>' .
               '  <td class="messageDataValue'.($show?'':'Grey').'" onclick=\'gotoElement("Question",null);refreshProjectSelectorList();stockHistory("Question",null,"object");setSelectedProject("'.htmlEnCode($proj->id).'","'.htmlEnCode($proj->name).'");\' style="cursor: pointer;">' . ($show?displayProgress($nbQuestions,$nbQuestionsAll,$nbQuestionsTodo,$nbQuestionsDone):'') . '</td>' .
               '</tr>';   
        }
      }
      echo '</table>';
