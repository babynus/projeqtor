...
class MeetingPlanningElementMain extends PlanningElement {
  ...
  //private static $_databaseCriteria = array('refType'=>'Meeting'); // Cannot use auto filter as PeriodicMeeting is a Meeting (no PeriodicMeetingPlanningElement exists)
