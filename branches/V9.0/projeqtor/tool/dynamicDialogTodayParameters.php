...
$today=new Today();
  ...
  echo '  <td class="dialogLabel" style="width:10%;"><label>'.i18n('colDueDate').$newGuiDisplayDoublePoint.'</label></td>';
  ...
  echo '</tr>';
  echo '<tr style="height:10px;">';
  echo '  <td class="dialogLabel" style="width:10%;"><label>'.i18n('colOrNotSet').$newGuiDisplayDoublePoint.'</label></td>';
  echo '  <td style="width:90%;">';
  ...
  echo '<tr><td></td><td>&nbsp;</td></tr>';
  echo '<tr style="height:10px;">';
  echo '  <td class="dialogLabel" style="width:10%;""><label>'.i18n('todayRefreshParametersRefresh').$newGuiDisplayDoublePoint.'</label></td>';
  echo '  <td style="width:90%;">';
  ...
  echo '</tr>';
  echo '<tr style="height:10px;">';
  echo '  <td class="dialogLabel" style="width:10%;"><label>'.i18n('todayRefreshParametersScroll').$newGuiDisplayDoublePoint.'</label></td>';
  echo '  <td style="width:90%;">';
