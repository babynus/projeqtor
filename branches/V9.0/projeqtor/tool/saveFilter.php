...
echo "<div id='saveFilterResult' style='z-index:9;position: absolute;left:50%;width:100%;margin-left:-50%;top:20px' onload='alert(\"temp\");clearDivTemporised(\"saveFilterResult\");' >";
