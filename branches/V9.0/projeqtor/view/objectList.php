...
// MTY - LEAVE SYSTEM              
            ...
            <td style="width:200px;text-align: right; align: right;min-width:150px" >
              ...
              <!-- END ADD qCazelles -->
                  ...
                  <td><div id="filterDivs" name="filterDivs" style="display:<?php echo $display;?>"><table><tr>  
            ...
            <td width="51px" class="allSearchFixLength">
              ...
              title="<?php echo i18n('advancedFilter')?>"  
               ...
               <?php if (!isNewGui()){?>
                ...
                <?php } ?>
                <div dojoType="dijit.TooltipDialog" id="directFilterList" style=" <?php if(isNewGui()){ ?> width:400px; <?php }?> z-index: 999999;<!-- display:none; --> position: absolute;">
                  <?php 
