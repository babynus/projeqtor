...
ALTER TABLE `pokersession` CHANGE `handledDate` `handledDate` DATE NULL DEFAULT NULL;
ALTER TABLE `pokersession` CHANGE `doneDate` `doneDate` DATE NULL DEFAULT NULL;
ALTER TABLE `pokersession` CHANGE `idleDate` `idleDate` DATE NULL DEFAULT NULL;
