...
ALTER TABLE `${prefix}pokersession` CHANGE `handledDate` DATE  DEFAULT NULL;
ALTER TABLE `${prefix}pokersession` CHANGE `doneDate` DATE  DEFAULT NULL;
ALTER TABLE `${prefix}pokersession` CHANGE `idleDate` DATE  DEFAULT NULL;
