...
echo '     flipPokerVote('.$pokerItem->id.','.$idPokerSession.');';
echo '   </script>';
echo ' </button>';
...
echo '   <script type="dojo/connect" event="onClick" args="evt">';
echo '     closePokerItemVote('.$pokerItem->id.','.$idPokerSession.');';
echo '   </script>';
echo ' </button>';
if($previous){
	...
	echo '   <script type="dojo/connect" event="onClick" args="evt">';
	echo '     pokerItemNav('.$idPokerSession.','.$pokerItem->id.',\''.$list.'\', \'previous\');';
	echo '   </script>';
	echo ' </button>';
}
if($next){
	...
	echo '   <script type="dojo/connect" event="onClick" args="evt">';
	echo '     pokerItemNav('.$idPokerSession.','.$pokerItem->id.',\''.$list.'\', \'next\');';
	echo '   </script>';
	echo ' </button>';
}
echo '</div>';
