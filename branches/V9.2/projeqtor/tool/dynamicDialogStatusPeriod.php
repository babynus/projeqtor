 ...
 */
  ...
  foreach ( $list as $statusPeriod ) {
    ...
    echo '<table><tr><td style="float:left">'.formatUserThumb($statusPeriod->idUserStart, $userName, 'Creator').'</td><td>'.$userName.'</td></tr></table></td>';
    ...
    echo '<td class="linkData" style="white-space:nowrap;width:10%">';
    echo '<table><tr><td style="float:left">'.formatUserThumb($statusPeriod->idUserEnd, $userName, 'Creator').'</td><td>'.$userName.'</td></tr></table></td>';
